...
with tf.device('/device:GPU:0'):
    ...
    model = get_cnn_model(num_filters=200, kernel_size=64, num_layers=2)
    print(model.summary())
    ...
    # Show the plot
    plt.savefig('Boxplot_MDPE_CNN.png')
    ...
    plt.ylabel('Tz [Nm]')
    plt.xlim([0, 360])
    plt.savefig('Highest_Error_Cycle_CNN.png')
    ...
    plt.savefig('Mean_Cycle_CNN.png')
